...
| P5 | bascule `v2` par défaut + **suppression** de l'ancien chemin | zéro code mort (règle du projet) — P5a ✅ (v2 défaut, fidélité, LTM voix, vocal, briefs) ; P5b (suppression v1) à venir |
