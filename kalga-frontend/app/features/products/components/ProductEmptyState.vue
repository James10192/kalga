<!--
  État vide pour la liste de produits — CTA création.
...
<template>
  ...
  >
    ...
    >
      <Package class="h-7 w-7" aria-hidden="true" />
    </div>
    ...
    <NuxtLink
      ...
      class="mt-6 inline-flex items-center gap-2 rounded-md bg-brand-forest px-5 py-2.5 text-sm font-medium text-brand-gold transition hover:bg-brand-forest/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
