<!--
  ...
  Référence : routes.ts:ROUTES.errors.forbidden
-->
...
<template>
  <div class="w-full max-w-md text-center">
    <div
      class="mx-auto mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-muted text-muted-foreground"
    >
